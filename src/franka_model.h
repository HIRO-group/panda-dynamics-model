...
Eigen::Vector7d Coriolis_row0(const Eigen::Vector7d &q,const Eigen::Vector7d &dq);
Eigen::Vector7d Coriolis_row1(const Eigen::Vector7d &q,const Eigen::Vector7d &dq);
Eigen::Vector7d Coriolis_row2(const Eigen::Vector7d &q,const Eigen::Vector7d &dq);
Eigen::Vector7d Coriolis_row3(const Eigen::Vector7d &q,const Eigen::Vector7d &dq);
Eigen::Vector7d Coriolis_row4(const Eigen::Vector7d &q,const Eigen::Vector7d &dq);
Eigen::Vector7d Coriolis_row5(const Eigen::Vector7d &q,const Eigen::Vector7d &dq);
Eigen::Vector7d Coriolis_row6(const Eigen::Vector7d &q,const Eigen::Vector7d &dq);
